...
echo "Warning: This script will OVERWRITE the remote repository with your local files."
...
echo "Force pushing to GitHub (this will overwrite any remote changes)..."
